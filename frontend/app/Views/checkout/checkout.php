            ...
            <div x-show="!showForm" x-cloak>
                <?php if ($selected_address): ?>
                    <div class="mb-4 p-2 bg-gray-100 rounded">
                        ...
                        <p><?php echo htmlspecialchars($addr['name'] . ' - ' . $addr['phone'] . ' - ' . $addr['street'] . ', ' . $addr['city'] . ', ' . $addr['country_code'] . ' - ' . ($addr['detail'] ?? '')); ?></p>
                    </div>
                <?php endif; ?>
                    ...
                    <ul class="space-y-2">
                        <?php foreach ($addresses as $addr): ?>
                            <li class="p-2 border rounded flex justify-between items-center">
                                <span class="flex-1">
                                    <?php echo htmlspecialchars($addr['name'] . ' - ' . $addr['phone'] . ' - ' . $addr['street'] . ', ' . $addr['city'] . ', ' . $addr['country_code'] . ' - ' . ($addr['detail'] ?? '')); ?>
                                </span>
            ...
            <ul class="space-y-4">
                <?php foreach ($cart_items as $item): ?>
                    <li class="flex items-center">
                        <img src="<?php echo htmlspecialchars($item['image'] ?? '/placeholder.jpg'); ?>" alt="<?php echo htmlspecialchars($item['product_name']); ?>" class="w-16 h-16 object-cover mr-4">
                        <div>
